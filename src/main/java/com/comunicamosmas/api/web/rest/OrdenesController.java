...
public class OrdenesController {
    ...
    public ResponseEntity<?> save(@RequestParam Long idContrato, @RequestParam Long tipoOrden , @RequestParam Long idUser , @RequestParam String nota)
    {
    	Map<String, Object> response = new HashMap<>();
    	try {
    ...
    public ResponseEntity<?> findbyidservicioandtipocliente(@RequestParam Long tipoOrden, @RequestParam Long idServicio , @RequestParam String tipoCliente)
    {
    	Map<String, Object> response = new HashMap<>();
    	
    	try {
    		
    		List<OrdenByTipoOrdenDTO> result = ordenService.listOrdenesByIdServicioAndTipoCliente(tipoOrden, idServicio, tipoCliente);
    		response.put("response", result);
