...
public interface IDireccionDao extends JpaRepository<Direccion, Long> {
    ...
    "CONCAT(d.a_tipo, ' ' , d.a_numero , ' ' , d.a_letra, ' ',d.b_tipo, ' ' , d.b_numero, ' ',d.a_letra) as direccion, \n"+
    "CONCAT(d2.a_tipo, ' ' , d2.a_numero , ' ' , d2.a_letra, ' ',d2.b_tipo, ' ' , d2.b_numero, ' ',d2.a_letra ,' / ',d2.barrio , ' / ', lm2.municipio ,' / ' ,ld2.departamento ) as facturacion from contratos co \n"+
