...
public interface IOrdenEstadoDao extends CrudRepository<OrdenEstado, Long> {
	...
	public Optional<List<OrdenEstado>> findByEstadoAndEstacion(Long estado , Long estacion);

	public Optional<List<OrdenEstado>> findByEstadoAndReservadaAndEstacion(Long estado , Long reservada , Long estacion);
